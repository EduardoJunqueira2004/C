...
/*
    *strcpy is used to copy the contents of one string to another. Its syntax is strcpy(dest, src), where dest is the destination string and src is the source string.
*/
    strcpy(temp2, name);
    strcpy(name, name2);
